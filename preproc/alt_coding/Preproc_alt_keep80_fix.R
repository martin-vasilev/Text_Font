...
write.csv(less80, file= 'preproc/alt_coding/less80.csv')

table(less80$Rtn_sweep_type)
chisq.test(table(less80$Rtn_sweep_type))
...
fileConn<- file("preproc/alt_coding/Preproc_summary.txt", "w")
...
Alldata<- raw_fix
save(Alldata, file= "preproc/alt_coding/Alldata.Rda")
write.csv(Alldata, "preproc/alt_coding/Alldata.csv")
...
save(RS, file= "preproc/alt_coding/Return_sweep.Rda")
write.csv(RS, file= "preproc/alt_coding/Return_sweep.csv")
