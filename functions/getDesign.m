function design = getDesign(filename, startRow, endRow)
...
%
% Example:
%   P1 = importfile('P1.txt', 2, 127);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/09/06 13:32:40
...
P1 = table(dataArray{1:end-1}, 'VariableNames', {'item','sound','pos'});
